        ...
        <div id="wrapper" >
                            ...
                            <div class="pull-right menu">
                                <nav class="pull-left menu-bar" id="responsive-menu">
                                    <ul  class=" site-menu" >
                                        ...
                                        <li class="item-202"><a class="menu-font" href="/info.html">公司简介</a></li>

                                        <li class="item-237 deeper parent"><a class="menu-font" href="#stop">项目介绍</a>
                                            <ul class="nav-child unstyled small">
                                                <li class="item-203"><a class="menu-font" href="/property.html">房产介绍</a></li>
                                                <li class="item-204"><a class="menu-font" href="/reception.html">商务接待</a></li>
                                                <li class="item-205"><a class="menu-font" href="/immigration.html">移民须知</a></li>
                                            </ul>
                                        </li>

                                        <li class="item-206"><a class="menu-font" href="/partner.html">合伙人</a></li>
                                        <li class="item-207"><a class="menu-font" href="/case.html">成功案例</a></li>
            ...
            <div id="component">
                                    ...
                                    <ul>
                                        <li class="even lastItem">
                                            ...
                                            <div class="container">
                                                ...
                                                <h2 style="font-size: 25px; line-height: 1.5em ">奥莱-EBS投资管理有限公司 e.b.s欧洲商务有限公司意大利唯一一家集律师,会计师,经济评估师为一体的商务服务公司。在罗马,香港,南京,上海设有专家团队和客服团队的海外置业投资公司。</h2>
                                        ...
                                        <li class="even lastItem">
                                            ...
                                            <div class="moduleItemIntrotext">
                                                ...
                                                <div class="col-lg-4" style="margin-bottom: 35px;">
                                                    <h3 style="line-height: 15.8079996109009px;">
                                                        <img src="images/firstIcon.png" alt=""
                                                             ...
                                                             style="line-height: 1.3em;">投资移民</span>
                                                    </h3>
                                                    <br />
                                                    <p class="margint10">多年投资意大利移民，置业移民，以及劳工移民的经济经验。关于房源：我公司在意大利拥有千余房源，供您选择。</p>
                                                </div>
                                                <div class="col-lg-4" style="margin-bottom: 35px;">
                                                    <h3>
                                                        <img src="images/secondIcon.png" alt=""
                                                             style="margin-right: 15px; height: 35px;" />拒绝陷阱
                                                    </h3>
                                                    <br />
                                                    <p class="margint10">律师团队全程陪同购房，确保产权安全，全程陪同办理意大利居留</p>
                                                </div>
                                                ...
                                                <div class="col-lg-4" style="margin-bottom: 35px;">
                                                    ...
                                                    <br />
                                                    <p class="margint10">买房之后提供一年后续服务，确保融入意大利生活。会计师全程提供海外安家方案及预算。移民之后：免费提供学校资讯，帮助办理免费医疗卡。</p>
                                                </div>
                ...
                <div class="container-grey">
                    ...
                    <div class="container">
                        ...
                        <div class="section-title-text">
                            <h2 style="margin-top: 30px;  margin-bottom: 10px; font-size: 42px;">合伙人介绍
                                <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                                </span>
                            </h2>
                        </div>
                        ...
                        <div class="row portfolio-box">
                            ...
                            <!--testimonial-main-container contains the hover function
                            ...
                            <div class="col-lg-3 col-sm-3 item">
                                <a href="" target="_blank" alt="">
                                    ...
                                    <div class="col-lg-8 col-sm-8 testimonial-content">
                                        <!-- Titolo -->
                                        <div>
                                            <p class="testimonial-title testimonial-text-align">郭屹</p>
                                        </div>
                                        <!-- Deascrizione -->
                                        <div class="testimonial-description">
                                            <p>中国大陆市场负责人，资深经纪人</p>
                ...
                <div class="container"style="margin-bottom: -20px">
                    ...
                    <div class="section-title-text">
                        <h2 style="margin-top: 30px;  margin-bottom: 10px; font-size: 42px;">开发商介绍
                            <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                            </span>
                        </h2>
                    </div>
                ...
                <div class="container-grey">
                    <div class="container">
                        <div class="row portfolio-box">
                            ...
                            <div class="section-title-text">
                                <h2 style="margin-top: 30px;  margin-bottom: 10px; font-size: 42px;">房产信息
                                    <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                                    </span>
                                </h2>
                            </div>
                    ...
                    <div class="module-inner">
                        <div class="module-ct">
                            <div class="custom"  >
                                ...
                                <div class="section-title-text">
                                    <h2 style="margin-top: 30px;  margin-bottom: 10px; font-size: 42px;">支持单位
                                        <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                                        </span>
                                    </h2>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-3 item ">
                                    <a href="" target="_blank">
                                        <img class="img-responsive" src="images/supporter/iceps.jpg" alt="" style="float: left; margin-right: 30px; padding-top: 5px;" /></a>
                                </div>
                                <div class="col-lg-6 col-sm-6 item ">
                                    <a href="" target="_blank">
                                        <img class="img-responsive" src="images/supporter/hqitaly.jpg" alt="" style="float: left; margin-right: 30px; padding-top: 5px;" /></a>
                                </div>    
                                <p> </p>
                            </div>
                        </div>
                                                    ...
                                                    <ul>
                                                        <li class="even lastItem">
                                                            ...
                                                            <div class="moduleItemIntrotext">
                                                                ...
                                                                <p>Via angelo poliziano 80 Interno 1
                                                                    roma, RM 00184 Italy</p>
                                                            </div>

        ...
        <div id="wrapper" >
            ...
            <div id="component">
                ...
                <div class="container-grey">
                    ...
                    <div class="container">
                        ...
                        <div class="section-title-text">
                            <h2 style="margin-top: 60px;  margin-bottom: 10px; font-size: 42px;">合伙人介绍
                ...
                <div class="container">
                    ...
                    <div class="section-title-text">
                        <h2 style="margin-top: 60px;  margin-bottom: 10px; font-size: 42px;">开发商介绍
                            <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                            </span>
                        </h2>
                    </div>
                ...
                <div class="container-grey">
                    <div class="container">
                        <div class="row portfolio-box">
                            ...
                            <div class="section-title-text">
                                <h2 style="margin-top: 60px;  margin-bottom: 10px; font-size: 42px;">成功案例
                                    <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                                    </span>
                                </h2>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-4 item ">
                                <div class="catItemView blog-box groupLeading">
                                    ...
                                    <div class="editions-legend clearfix" style="width: 90%; height: auto;">
                                        <a href="/tianjin-haiwailianyihui-liujinquan.html">罗马</a>
                                    </div>
                                    <div class="clr"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-4 item ">
                                <div class="catItemView blog-box groupLeading">
                                    <div class="blg-img-box" style="width: 90%; height: auto;">
                                        <a href="/tianjin-binhai-qiatanhui.html"> <img
                                    ...
                                    <div class="editions-legend clearfix" style="width: 90%; height: auto;">
                                        <a href="/tianjin-binhai-qiatanhui.html">佛罗伦萨</a>
                                    </div>
                    ...
                    <div class="module-inner">
                        <div class="module-ct">
                            <div class="custom"  >
                                ...
                                <div class="section-title-text">
                                    <h2 style="margin-top: 60px;  margin-bottom: 10px; font-size: 42px;">支持单位
                                        <span>我们的专家团队和客服团队竭诚为您提供最专业的海外置业服务
                                        </span>
                                    </h2>
                                </div>
